...
const WEEKLY_CLASS_SCHEDULE = {
  "شنبه": ["عربی ۳", "فرهنگ و هنر", "مطالعات اجتماعی"],
  "یکشنبه": ["زبان انگلیسی ۳", "معارف اسلامی ۳", "املا و نگارش ۳"],
  "دوشنبه": ["تربیت بدنی ۳", "علوم تجربی", "ریاضی ۳"],
  "سه‌شنبه": ["قرآن", "فارسی ۳", "مطالعات اجتماعی / علوم تجربی"],
  "چهارشنبه": ["ریاضی ۳", "آمادگی دفاعی", "کار و فناوری ۳"],
  "پنجشنبه": [],
  "جمعه": []
};
